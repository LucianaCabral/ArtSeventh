...
internal object MovieStub {
        ...
        init = {
            Movie(
                ...
                overview = "A história do físico americano J. Robert Oppenheimer, " +
                        "seu papel no Projeto Manhattan e no desenvolvimento da bomba atômica " +
                        "durante a Segunda Guerra Mundial, e o quanto isso mudaria a história do mundo para sempre.",
                popularity = 2464.545,
                id = 872585,
    ...
    val pagingData = PagingData.from(movieResponse)
}
